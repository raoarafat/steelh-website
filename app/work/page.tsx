    ...
    <main className="flex flex-col min-h-screen bg-[#f7f3e9] text-[#333] pt-16">
      ...
      <section className="h-[70vh] flex items-center justify-center bg-[#f7f3e9] relative overflow-hidden">
        ...
        <div className="max-w-[1200px] mx-auto px-6 w-full relative z-10 text-center">
          <h1 className="text-3xl md:text-5xl font-semibold mb-6 tracking-tight">Case Studies</h1>
          <p className="text-xl md:text-2xl max-w-2xl mx-auto text-gray-300">
            Transforming businesses through strategic IT staffing and workforce solutions
          </p>
        </div>
      </section>
        ...
        <div className="max-w-[1200px] mx-auto px-6">
          ...
          <div className="mb-32">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div>
                <h3 className="text-3xl font-medium mb-2">Financial Services IT Transformation</h3>
                <p className="text-gray-400">Banking & Financial Services</p>
              </div>
              <div>
                <p className="text-gray-300 mb-6">
                  We helped a leading financial institution build a specialized team of 25 IT professionals to modernize
                  their legacy systems, resulting in a 40% improvement in processing times and enhanced security
                  protocols.
                </p>
          ...
          <div className="mb-32">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div>
                <h3 className="text-3xl font-medium mb-2">Healthcare IT Staffing</h3>
                <p className="text-gray-400">Healthcare</p>
              </div>
              <div>
                <p className="text-gray-300 mb-6">
                  We provided a healthcare provider with a dedicated team of IT specialists to implement a new
                  electronic health records system, improving patient data management and reducing administrative
                  overhead by 35%.
                </p>
          ...
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div>
                <h3 className="text-3xl font-medium mb-2">E-commerce Platform Development</h3>
                <p className="text-gray-400">Retail</p>
              </div>
              <div>
                <p className="text-gray-300 mb-6">
                  We assembled a specialized team of developers, architects, and QA engineers to help a retail brand
                  build a scalable e-commerce platform, resulting in a 30% increase in online sales and improved
                  customer experience.
                </p>
      ...
      <section className="py-24 bg-[#f7f3e9]">
        <div className="max-w-[1200px] mx-auto px-6">
          <h2 className="text-4xl font-semibold mb-16 text-center">Industries We Serve</h2>
      ...
      <section className="py-24 bg-[#333]">
        <div className="max-w-[1200px] mx-auto px-6 text-center">
          ...
          <p className="text-xl max-w-2xl mx-auto mb-12 text-[#f7f3e9]/80">
            Let's discuss how our IT staffing expertise can help your business innovate and grow.
          </p>
          <Link href="/contact">
